...
const PIECE_WEIGHTS: { [key: string]: number } = {
  ...
  'pear': 180, 'pears': 180,
  'peach': 150, 'peaches': 150,
  'plum': 80, 'plums': 80,
  'grape': 5, 'grapes': 5,
  'strawberry': 12, 'strawberries': 12,
  'blueberry': 2, 'blueberries': 2,
  'watermelon': 15000, 'watermelons': 15000,
  'melon': 1000, 'melons': 1000,
  'pineapple': 1000, 'pineapples': 1000,
  
  // Vegetables
  'carrot': 60, 'carrots': 60,  // 1 medium carrot ≈ 60g
  'potato': 150, 'potatoes': 150,  // 1 medium potato ≈ 150g
  'onion': 150, 'onions': 150,  // 1 medium onion ≈ 150g
  'tomato': 120, 'tomatoes': 120,  // 1 medium tomato ≈ 120g
  'cucumber': 300, 'cucumbers': 300,
  'capsicum': 120, 'capsicums': 120,
  'bell pepper': 120, 'bell peppers': 120,
  'broccoli': 300, 'broccolis': 300,
  'cauliflower': 600, 'cauliflowers': 600,
  'eggplant': 300, 'eggplants': 300,
  'brinjal': 300, 'brinjals': 300,
  'spinach': 30, 'spinaches': 30,
  'lettuce': 200, 'lettuces': 200,
  'cabbage': 1000, 'cabbages': 1000,
  'garlic': 5, 'garlics': 5,
  'ginger': 50, 'gingers': 50,
  'chili': 10, 'chilies': 10, 'chillis': 10,
  'green chili': 10, 'green chilies': 10,
  'lemon': 60, 'lemons': 60,
  'lime': 50, 'limes': 50,
  'corn': 300, 'corns': 300,
  'peas': 50,  // per pod
  ...
  'okra': 20, 'okras': 20,
  'ladies finger': 20, 'ladies fingers': 20,
  'bitter gourd': 150, 'bitter gourds': 150,
  'bottle gourd': 1000, 'bottle gourds': 1000,
  'ridge gourd': 250, 'ridge gourds': 250,
  'drumstick': 150, 'drumsticks': 150,
  'beetroot': 150, 'beetroots': 150,
  'radish': 100, 'radishes': 100,
  'turnip': 150, 'turnips': 150,
  
  // Indian Breads
  'roti': 30, 'rotis': 30,
  'chapati': 30, 'chapatis': 30,
  'paratha': 50, 'parathas': 50,
  'naan': 80, 'naans': 80,
  'kulcha': 60, 'kulchas': 60,
  'puri': 25, 'puris': 25,
  'bhatura': 40, 'bhaturas': 40,
  'dosa': 80, 'dosas': 80,
  'idli': 40, 'idlis': 40,
  'uttapam': 100, 'uttapams': 100,
  'appam': 60, 'appams': 60,
  'bread': 30, 'breads': 30,
  'slice': 30, 'slices': 30,
  'bun': 40, 'buns': 40,
  ...
  'pakora': 25, 'pakoras': 25,
  'vada': 40, 'vadas': 40,
  'bonda': 40, 'bondas': 40,
  'cutlet': 60, 'cutlets': 60,
  'roll': 150, 'rolls': 150,
  'burger': 250, 'burgers': 250,
  'sandwich': 200, 'sandwiches': 200,
  'pizza': 800, 'pizzas': 800,
  'slice of pizza': 200,
  'pasta': 100, 'pastas': 100,
  'noodle': 100, 'noodles': 100,
  'spring roll': 50, 'spring rolls': 50,
  'momos': 20, 'momo': 20,
  'kachori': 40, 'kachoris': 40,
  'jalebi': 30, 'jalebis': 30,
  'ladoo': 40, 'ladoos': 40,
  'barfi': 40, 'barfis': 40,
  'gulab jamun': 50, 'gulab jamuns': 50,
  'rasgulla': 50, 'rasgullas': 50,
  
  // Dairy
  'cheese': 30, 'cheeses': 30,
  'cheese slice': 20,
  'paneer': 50, 'paneers': 50,
  'tofu': 150, 'tofus': 150,
  'yogurt': 150, 'yogurts': 150,
  'curd': 150, 'curds': 150,
  'dahi': 150,
  'milk': 250, 'milks': 250,  // 1 cup
  'lassi': 300, 'lassis': 300,
  'buttermilk': 250,
  'butter': 10, 'butters': 10,  // per pat
  'ghee': 15,  // per spoon
  'cream': 15,
  'ice cream': 100, 'ice creams': 100,
  'kulfi': 80, 'kulfis': 80,
  
  // Meat & Fish
  'chicken': 150, 'chickens': 150,
  'chicken breast': 150,
  'chicken thigh': 100,
  'chicken leg': 120,
  'chicken wing': 40,
  ...
  'tuna': 150,
  'mackerel': 150,
  'sardine': 20, 'sardines': 20,
  'prawn': 15, 'prawns': 15,
  'shrimp': 15, 'shrimps': 15,
  'mutton': 150, 'muttons': 150,
  'lamb': 150,
  'beef': 150,
  'pork': 150,
  'sausage': 50, 'sausages': 50,
  'bacon': 30, 'bacons': 30,
  'ham': 30, 'hams': 30,
  ...
  // Grains & Legumes
  'rice': 200, 'rices': 200,  // 1 cup cooked
  'pancake': 40, 'pancakes': 40,
  'waffle': 50, 'waffles': 50,
  'croissant': 60, 'croissants': 60,
  'muffin': 60, 'muffins': 60,
  'bagel': 90, 'bagels': 90,
  'donut': 60, 'donuts': 60,
  'cookie': 15, 'cookies': 15,
  'biscuit': 15, 'biscuits': 15,
  ...
  'cashew': 1.5, 'cashews': 1.5,
  'walnut': 4, 'walnuts': 4,
  'pistachio': 0.7, 'pistachios': 0.7,
  'peanut': 0.6, 'peanuts': 0.6,
  ...
  // Beverages
  'tea': 250, 'teas': 250,  // 1 cup
  'coffee': 250, 'coffees': 250,
  'juice': 250, 'juices': 250,
  'smoothie': 300, 'smoothies': 300,
  'soda': 330, 'sodas': 330,
  'soft drink': 330, 'soft drinks': 330,
  'water': 250, 'waters': 250,
  'beer': 350, 'beers': 350,
  'wine': 150, 'wines': 150,
  
  // Sweets & Desserts
  'chocolate': 20, 'chocolates': 20,
  'candy': 10, 'candies': 10,
  'cake': 100, 'cakes': 100,
  'pastry': 80, 'pastries': 80,
  'pie': 150, 'pies': 150,
  'pudding': 150, 'puddings': 150,
  'custard': 150,
  'halwa': 100, 'halwas': 100,
  'kheer': 200,
  'payasam': 200,
  'rabri': 150,
  'shrikhand': 150,
  'basundi': 150,
  'sandesh': 30, 'sandeshs': 30,
  'rosogolla': 50, 'rosogollas': 50,
  'mishti doi': 150,
...
export class AiService {
  ...
  constructor(private readonly configService: ConfigService) {
    ...
    this.apiServiceKey = this.configService.get<string>('API_SERVICE_KEY') || '';
  }
  ...
  async chatWithImage(message: string, imageBase64: string, context: ChatContext) {
    try {
      // Build context message with user profile and today's food data
      const contextMessage = this.buildContextMessage(context);
      ...
      if (!res.ok) {
        ...
        if (res.status === 404) {
          console.log('Chat with image endpoint not found, falling back to text-only chat');
...
Please describe the food in the image (e.g., "grilled chicken with vegetables"), and I'll provide personalized feedback on whether it's a good choice for your diet and goals!` 
  ...
  private buildContextMessage(context: ChatContext): string {
    ...
    if (user) {
      ...
      if (user.activityLevel) contextMessage += `- Activity Level: ${user.activityLevel}\n`;
      if (user.dietType) contextMessage += `- Diet Type: ${user.dietType}\n`;
      if (user.primaryGoal) contextMessage += `- Primary Goal: ${user.primaryGoal}\n`;
      contextMessage += '\n';
    }
  ...
  private calculateDailyTargets(user: User, consumed: any) {
    ...
    const activityMultiplier = activityMultipliers[user.activityLevel?.toLowerCase() || ''] || 1.2;
    ...
    let proteinTarget = Math.round(weight * (activityMultiplier > 1.55 ? 1.6 : 0.8));
    ...
    if (user.dietType?.toLowerCase().includes('keto')) {
      ...
      proteinTarget = Math.round((calorieTarget - (fatTarget * 9) - (carbsTarget * 4)) / 4);
      ...
      proteinTarget = Math.round((calorieTarget - (carbsTarget * 4) - (fatTarget * 9)) / 4);
    }
  ...
  private async getUSDANutrients(foodName: string, grams: number): Promise<NutrientData | null> {
    if (!this.usdaApiKey) {
      return null;
    }
    ...
    try {
      ...
      return {
        calories: Math.round((nutrients[NUTRIENT_IDS.calories] || 0) * scaleFactor * 100) / 100,
        fat: Math.round((nutrients[NUTRIENT_IDS.fat] || 0) * scaleFactor * 100) / 100,
        protein: Math.round((nutrients[NUTRIENT_IDS.protein] || 0) * scaleFactor * 100) / 100,
        carbohydrates: Math.round((nutrients[NUTRIENT_IDS.carbohydrates] || 0) * scaleFactor * 100) / 100,
        micronutrients: {
          vitamin_c: Math.round((nutrients[NUTRIENT_IDS.vitamin_c] || 0) * scaleFactor * 100) / 100,
          iron: Math.round((nutrients[NUTRIENT_IDS.iron] || 0) * scaleFactor * 100) / 100,
          calcium: Math.round((nutrients[NUTRIENT_IDS.calcium] || 0) * scaleFactor * 100) / 100,
          vitamin_d: Math.round((nutrients[NUTRIENT_IDS.vitamin_d] || 0) * scaleFactor * 100) / 100,
          vitamin_a: Math.round((nutrients[NUTRIENT_IDS.vitamin_a] || 0) * scaleFactor * 100) / 100,
          vitamin_b12: Math.round((nutrients[NUTRIENT_IDS.vitamin_b12] || 0) * scaleFactor * 100) / 100,
          vitamin_b6: Math.round((nutrients[NUTRIENT_IDS.vitamin_b6] || 0) * scaleFactor * 100) / 100,
          folate: Math.round((nutrients[NUTRIENT_IDS.folate] || 0) * scaleFactor * 100) / 100,
          magnesium: Math.round((nutrients[NUTRIENT_IDS.magnesium] || 0) * scaleFactor * 100) / 100,
          potassium: Math.round((nutrients[NUTRIENT_IDS.potassium] || 0) * scaleFactor * 100) / 100,
          zinc: Math.round((nutrients[NUTRIENT_IDS.zinc] || 0) * scaleFactor * 100) / 100,
          selenium: Math.round((nutrients[NUTRIENT_IDS.selenium] || 0) * scaleFactor * 100) / 100,
          copper: Math.round((nutrients[NUTRIENT_IDS.copper] || 0) * scaleFactor * 100) / 100,
          manganese: Math.round((nutrients[NUTRIENT_IDS.manganese] || 0) * scaleFactor * 100) / 100,
          iodine: Math.round((nutrients[NUTRIENT_IDS.iodine] || 0) * scaleFactor * 100) / 100,
        },
      };
    } catch (error) {
      return null;
  ...
  private getFallbackNutrients(grams: number): NutrientData {
    ...
    return {
      ...
      micronutrients: {
        vitamin_c: 0, iron: 0, calcium: 0, vitamin_d: 0, vitamin_a: 0,
        vitamin_b12: 0, vitamin_b6: 0, folate: 0, magnesium: 0, potassium: 0,
  ...
  async generateNutrient(data: GenerateNutrientDto) {
    const items_with_nutrients: FoodItemWithNutrients[] = [];
    ...
    for (const food of data.food) {
      ...
      const unit = food.unit?.toLowerCase() || 'g';
      const foodNameLower = food.name.toLowerCase();
      
      // Calculate grams based on unit
      let grams: number;
      
      if (['pcs', 'pc', 'piece', 'pieces'].includes(unit)) {
        // For piece-based units, look up the specific food weight
        // This gives accurate conversions (e.g., 1 carrot = 60g, 1 egg = 50g)
        const foodNameLower = food.name.toLowerCase().trim();
        
        // Try exact match first, then singular form (remove trailing 's')
        let pieceWeight = PIECE_WEIGHTS[foodNameLower];
        
        if (!pieceWeight && foodNameLower.endsWith('s')) {
          // Try singular form
          const singularForm = foodNameLower.slice(0, -1);
          pieceWeight = PIECE_WEIGHTS[singularForm];
        }
        
        // Also try some common variations
        if (!pieceWeight) {
          // Handle compound names (e.g., "green chili" vs "chili")
          const nameParts = foodNameLower.split(' ');
          if (nameParts.length > 1) {
            // Try the last word (e.g., "beans" from "green beans")
            pieceWeight = PIECE_WEIGHTS[nameParts[nameParts.length - 1]];
            
            // Try the full compound name
            if (!pieceWeight) {
              pieceWeight = PIECE_WEIGHTS[foodNameLower];
            }
          }
        }
        
        // Fall back to default 100g if food not found in mapping
        grams = quantity * (pieceWeight || 100);
      } else {
      ...
      // Try USDA API first
      let nutrient_data = await this.getUSDANutrients(food.name, grams);
      
      // Fallback to generic values if USDA fails
      if (!nutrient_data) {
        nutrient_data = this.getFallbackNutrients(grams);
      }
    ...
    const total_micronutrients: { [key: string]: number } = {};
    for (const item of items_with_nutrients) {
      for (const [nutrient, value] of Object.entries(item.micronutrients)) {
        total_micronutrients[nutrient] = (total_micronutrients[nutrient] || 0) + value;
      }
    }

    // Round totals
    for (const key of Object.keys(total_micronutrients)) {
      total_micronutrients[key] = Math.round(total_micronutrients[key] * 100) / 100;
    }

    return {
      total: {
        calories: Math.round(total_calories * 100) / 100,
        fat: Math.round(total_fat * 100) / 100,
        protein: Math.round(total_protein * 100) / 100,
        carbohydrates: Math.round(total_carbs * 100) / 100,
